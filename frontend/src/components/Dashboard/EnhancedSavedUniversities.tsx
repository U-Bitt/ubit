      ...
      <CardContent className="space-y-4">
        {universities.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-slate-500">Start exploring and save your favorites</p>
          </div>
        ) : (
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className={`${getStatusColor(university.status)} flex items-center gap-1 text-xs`}>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Button size="sm" variant="ghost" className="p-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                    <div className="text-center p-2 rounded-lg bg-slate-50 group-hover:bg-emerald-50 transition-colors duration-300">
                      ...
                      <p className={`text-sm font-bold ${getRankingColor(university.ranking)}`}>
                        #{university.ranking}
                      </p>
                    </div>
                    ...
                    <div className="text-center p-2 rounded-lg bg-slate-50 group-hover:bg-emerald-50 transition-colors duration-300">
                      ...
                      <p className="text-sm font-bold text-slate-900">{university.tuition}</p>
                    </div>
                    ...
                    <div className="text-center p-2 rounded-lg bg-slate-50 group-hover:bg-emerald-50 transition-colors duration-300">
                      ...
                      <p className="text-sm font-bold text-slate-900">{university.acceptance}</p>
                    </div>
                    ...
                    <div className="text-center p-2 rounded-lg bg-slate-50 group-hover:bg-emerald-50 transition-colors duration-300">
                      ...
                      <p className="text-sm font-bold text-slate-900">{university.deadline}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-slate-200">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        {expandedUniversity === university.id ? 'Hide Details' : 'Show Details'}
                      </Button>
                      <Button 
                        size="sm" 
                        variant="ghost" 
                  ...
                  {/* Expanded Details */}
                  {expandedUniversity === university.id && university.details && (
                    <div className="mt-4 pt-4 border-t border-slate-200 space-y-4">
                      <h4 className="font-semibold text-slate-900 mb-3">Detailed Information</h4>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {university.details.founded && (
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-xs text-slate-500 font-medium">Founded</p>
                              <p className="text-sm font-semibold text-slate-900">{university.details.founded}</p>
                            </div>
                          </div>
                        )}
                        ...
                        {university.details.students && (
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-semibold text-slate-900">{university.details.students}</p>
                            </div>
                          </div>
                        )}
                        ...
                        {university.details.faculty && (
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-semibold text-slate-900">{university.details.faculty}</p>
                            </div>
                          </div>
                        )}
                        ...
                        {university.details.endowment && (
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-xs text-slate-500 font-medium">Endowment</p>
                              <p className="text-sm font-semibold text-slate-900">{university.details.endowment}</p>
                            </div>
                          </div>
                        )}
                        ...
                        {university.details.type && (
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-xs text-slate-500 font-medium">Institution Type</p>
                              <p className="text-sm font-semibold text-slate-900">{university.details.type}</p>
                            </div>
                          </div>
                        )}
                        ...
                        {university.details.language && (
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-semibold text-slate-900">{university.details.language}</p>
                            </div>
                          </div>
                        )}
                      </div>
                      ...
                      {university.details.research && (
                        <div className="mt-4">
                          <p className="text-xs text-slate-500 font-medium mb-2">Research Focus</p>
                          <p className="text-sm text-slate-700 bg-slate-50 p-3 rounded-lg">{university.details.research}</p>
                        </div>
                      )}

                      {university.details.notable && (
                        <div className="mt-4">
                          <p className="text-xs text-slate-500 font-medium mb-2">Notable Achievements</p>
                          <p className="text-sm text-slate-700 bg-gradient-to-r from-yellow-50 to-orange-50 p-3 rounded-lg border border-yellow-200">{university.details.notable}</p>
                        </div>
                      )}
                      ...
                      {university.details.website && (
                        <div className="mt-4">
                          <Button 
                            ...
                            variant="outline" 
                            className="gap-2"
                            onClick={() => window.open(university.details!.website, '_blank')}
                          >
                            <ExternalLink className="h-3 w-3" />
                            Visit Website
                          </Button>
