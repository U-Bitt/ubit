...
export const ImproveCVModal = ({
  ...
  const generateCV = () => {
    ...
    setTimeout(() => {
      const sections: CVSection[] = [
        ...
        {
          title: "Education",
          content: `${userProfile.academicInfo.school as string} - ${userProfile.academicInfo.major as string} - GPA: ${userProfile.academicInfo.gpa as string}`,
          improved: `${userProfile.academicInfo.school as string}\n${userProfile.academicInfo.major as string} | Expected Graduation: ${userProfile.academicInfo.graduationYear as string}\nGPA: ${userProfile.academicInfo.gpa as string}/4.0\n\nRelevant Coursework: Data Structures, Algorithms, Software Engineering, Database Systems`,
          suggestions: [
        ...
        },
        {
          ...
          content: `${userProfile.personalInfo.email as string} | ${userProfile.personalInfo.phone as string}`,
          improved: `${userProfile.personalInfo.firstName as string} ${userProfile.personalInfo.lastName as string}\n${userProfile.personalInfo.email as string} | ${userProfile.personalInfo.phone as string}\n${userProfile.personalInfo.address as string}\nLinkedIn: linkedin.com/in/${(userProfile.personalInfo.firstName as string).toLowerCase()}-${(userProfile.personalInfo.lastName as string).toLowerCase()}`,
          suggestions: [
  ...
  const downloadCV = () => {
    ...
    a.href = url;
    a.download = `${userProfile.personalInfo.firstName as string}_${userProfile.personalInfo.lastName as string}_CV.txt`;
            ...
            {!isAnalyzing && cvSections.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Our AI will analyze your profile and suggest improvements for
                  each section of your CV.
                </p>
                  ...
                  <Card key={index} className="border-l-4 border-l-primary">
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <h5 className="font-medium mb-2 text-sm text-green-600">
                            AI Improved:
                          </h5>
