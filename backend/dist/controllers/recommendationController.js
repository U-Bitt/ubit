...
exports.getScholarshipRecommendations = exports.getProgramRecommendations = exports.getUniversityRecommendations = void 0;
...
const getUniversityRecommendations = async (req, res, next) => {
    try {
        const response = {
            success: true,
...
exports.getUniversityRecommendations = getUniversityRecommendations;
const getProgramRecommendations = async (req, res, next) => {
    try {
        const response = {
            success: true,
...
exports.getProgramRecommendations = getProgramRecommendations;
const getScholarshipRecommendations = async (req, res, next) => {
    try {
        const response = {
            success: true,
...
exports.getScholarshipRecommendations = getScholarshipRecommendations;
